function [fig] = prob_model(wind, fig)
...
[hist, ECDF] = Empirical_Data(wind, fig);
...
f1 = figure(fig);         fig = fig + 1;
f2 = figure(fig);         fig = fig + 1;
f3 = figure(fig);         fig = fig + 1;
f4 = figure(fig);         fig = fig + 1;
